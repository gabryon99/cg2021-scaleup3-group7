...
def apply_watermark():
    bucket_name = "cg2021-scaleup3-group7" # ✅
    ...
    qr_req_url = "https://qrackajack.expeditedaddons.com/?api_key=" + os.environ['QRACKAJACK_API_KEY'] + "&content=" + get_s3_url(bucket_name, filename)
    ...
    watermark_req_url = "https://watermarker.expeditedaddons.com/?api_key=" + os.environ['WATERMARKER_API_KEY'] + "&image_url=" + get_s3_url(bucket_name, filename) + "&opacity=100&position=center&watermark_url=" + get_s3_url(bucket_name, qr_name)
